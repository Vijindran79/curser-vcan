...
const STRIPE_PUBLISHABLE_KEY = import.meta.env.VITE_STRIPE_PUBLISHABLE_KEY || 'pk_live_51RnhihPyJngwy6BVAi9YTgB5kc1NMsOvqyqoJdnRFVrKAH0XvDxNWg5nBb27uObdag5nBHgAHGPEaqSa17YoYhQB006lp59yKe';
...
async function mountPaymentForm() {
    ...
    try {
        ...
        try {
            ...
            const FUNCTION_URL = 'https://us-central1-vcanship-onestop-logistics.cloudfunctions.net/createPaymentIntentV2';
